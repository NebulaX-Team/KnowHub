...
const MESSAGE_DICTIONARY: Record<string, TranslationPair> = {
  ...
  'Cannot restore page while parent is archived': { 'en-US': 'Cannot restore page while parent is archived', 'zh-CN': '父页面仍在归档中，无法恢复该页面' },
  'Cannot grant permission to the owner': { 'en-US': 'Cannot grant permission to the owner', 'zh-CN': '不能给资源所有者重复授权' },
  'Cannot modify team owner role': { 'en-US': 'Cannot modify team owner role', 'zh-CN': '不能修改团队所有者角色' },
  'Cannot remove team owner': { 'en-US': 'Cannot remove team owner', 'zh-CN': '不能移除团队所有者' },
  'Insufficient permission': { 'en-US': 'Insufficient permission', 'zh-CN': '权限不足' },
  'Insufficient team permission': { 'en-US': 'Insufficient team permission', 'zh-CN': '团队权限不足' },
  'Invite email does not match current account': { 'en-US': 'Invite email does not match current account', 'zh-CN': '邀请邮箱与当前账号不匹配' },
  'Invite has already been processed': { 'en-US': 'Invite has already been processed', 'zh-CN': '该邀请已处理' },
  'Invite has expired': { 'en-US': 'Invite has expired', 'zh-CN': '邀请已过期' },
  'Invite not found': { 'en-US': 'Invite not found', 'zh-CN': '邀请不存在' },
  'Permission not found': { 'en-US': 'Permission not found', 'zh-CN': '授权记录不存在' },
  'Registration is currently disabled': { 'en-US': 'Registration is currently disabled', 'zh-CN': '当前已关闭注册' },
  'Password reset is currently disabled': { 'en-US': 'Password reset is currently disabled', 'zh-CN': '当前已关闭密码重置' },
  ...
  'Template not found': { 'en-US': 'Template not found', 'zh-CN': '模板不存在' },
  'Team not found': { 'en-US': 'Team not found', 'zh-CN': '团队不存在' },
  'Team member not found': { 'en-US': 'Team member not found', 'zh-CN': '团队成员不存在' },
  'Only team owner can transfer ownership': { 'en-US': 'Only team owner can transfer ownership', 'zh-CN': '仅团队所有者可转让所有权' },
  'Target user is already the team owner': { 'en-US': 'Target user is already the team owner', 'zh-CN': '目标用户已是团队所有者' },
  'Invalid timezone format. Use UTC+8 or UTC-5:30': {
    'en-US': 'Invalid timezone format. Use UTC+8 or UTC-5:30',
    'zh-CN': '时区格式无效，请使用 UTC+8 或 UTC-5:30',
  },
  'Template title generation failed': { 'en-US': 'Template title generation failed', 'zh-CN': '模板标题生成失败' },
  'Cannot modify built-in template': { 'en-US': 'Cannot modify built-in template', 'zh-CN': '不能修改内置模板' },
  'Cannot delete built-in template': { 'en-US': 'Cannot delete built-in template', 'zh-CN': '不能删除内置模板' },
  ...
  'System has already been initialized': { 'en-US': 'System has already been initialized', 'zh-CN': '系统已完成初始化' },
  'Uploaded file not found': { 'en-US': 'Uploaded file not found', 'zh-CN': '未找到上传文件' },
  'User not found': { 'en-US': 'User not found', 'zh-CN': '用户不存在' },
  'User is already a team member': { 'en-US': 'User is already a team member', 'zh-CN': '该用户已是团队成员' },
  ...
  'Page archived successfully': { 'en-US': 'Page archived successfully', 'zh-CN': '页面已归档' },
  'Page restored successfully': { 'en-US': 'Page restored successfully', 'zh-CN': '页面已恢复' },
  'Page permanently deleted successfully': { 'en-US': 'Page permanently deleted successfully', 'zh-CN': '页面已永久删除' },
  'Page settings updated successfully': { 'en-US': 'Page settings updated successfully', 'zh-CN': '页面设置更新成功' },
  'Permission removed successfully': { 'en-US': 'Permission removed successfully', 'zh-CN': '授权移除成功' },
  'Permission updated successfully': { 'en-US': 'Permission updated successfully', 'zh-CN': '授权更新成功' },
  'Template deleted successfully': { 'en-US': 'Template deleted successfully', 'zh-CN': '模板删除成功' },
  'Team created successfully': { 'en-US': 'Team created successfully', 'zh-CN': '团队创建成功' },
  'Team member added successfully': { 'en-US': 'Team member added successfully', 'zh-CN': '团队成员添加成功' },
  'Team member removed successfully': { 'en-US': 'Team member removed successfully', 'zh-CN': '团队成员移除成功' },
  'Team member updated successfully': { 'en-US': 'Team member updated successfully', 'zh-CN': '团队成员更新成功' },
  'Team ownership transferred successfully': { 'en-US': 'Team ownership transferred successfully', 'zh-CN': '团队所有权转让成功' },
  ...
  'Invite accepted successfully': { 'en-US': 'Invite accepted successfully', 'zh-CN': '邀请接受成功' },
  'Invite canceled successfully': { 'en-US': 'Invite canceled successfully', 'zh-CN': '邀请取消成功' },
  'Invite created successfully': { 'en-US': 'Invite created successfully', 'zh-CN': '邀请创建成功' },
  'Invite declined successfully': { 'en-US': 'Invite declined successfully', 'zh-CN': '邀请已拒绝' },
